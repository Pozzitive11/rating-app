        ...
        <div className="flex justify-between items-start gap-4">
          <div className="flex gap-3">
            <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center shrink-0">
              <img src="/pwa-192x192.png" alt="App Icon" className="w-8 h-8 rounded-lg object-cover shadow-sm" />
            </div>
            
            <div className="flex flex-col">
              <h3 className="font-semibold text-foreground">Install Beer Rater</h3>
              <p className="text-sm text-muted-foreground mt-0.5">
                {isIOS 
                  ? "Get the full experience on your home screen." 
                  : "Install our app for a better, faster experience."}
              </p>
            </div>
          </div>
